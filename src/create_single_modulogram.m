...
validMask = ~isnan(align_times);
align_times = align_times(validMask);
trial_numbers = trial_numbers(validMask);
...
outputStruct = struct( ...
    ...
    'nTrials', nTrials, ...
    'alignTimes', align_times, ...
    'trialNumbers', trial_numbers, ...
    'modulogramFile', outFile, ...
    'subjectID', subjectID, ...
